def getEmergencyArray():
    sentences = [
        ...
        "doctor quick the patient just stabbed himself with a fork in the neck",
        "nurse look my mother keeps trying to climb out the window saying she can fly"
        "someone help my husband is having a seizure and stopped breathing"
